...
const cat = localStorage.setItem('LinuxDays');
localStorage.removeItem('LinuxDays');
```
...
const cat = sessionStorage.setItem('LinuxDays');
sessionStorage.removeItem('LinuxDays');
```
